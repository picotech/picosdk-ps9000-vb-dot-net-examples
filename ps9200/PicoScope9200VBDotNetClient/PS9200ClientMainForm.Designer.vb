...
Partial Class PS9200ClientMainForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.cbCommand.Items.AddRange(New Object() {"*Run", "*StopSingle Stop", "*Autoscale", "Wfm:Data?", "Wfm:Preamb?", "Header Off", "Header On"})
        ...
        Me.Text = "PicoScope 9200 VB.NET Client Example"
