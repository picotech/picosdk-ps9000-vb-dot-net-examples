'===================================================================================================
'	
'   Filename: PS9300ClientMainForm.vb
'
'	Description: 
'	    This file provides an example ActiveX client to communicate with the server provided by
'       the PicoSample 3 software application for PicoScope 9300 Series sampling oscilloscopes.
'
'   Copyright © 2015-2017 Pico Technology Ltd. See LICENSE file for terms.
'
'===================================================================================================

Public Class PS9300ClientMainForm

    Private Class COMRCWrapper

        Dim COMRC As PicoSample3.COMRC  ' COM object of the oscilloscope 
        ' Project | Add Reference... | COM | PicoSample3
        Sub New()
        ...
        Public Function ExecCommand(ByVal command As String) As String
            ...
            ElseIf result = "ERROR" Then
                MessageBox.Show("PicoSample3.COMRC command error (" & command & ")", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
    ...
    Private Sub btnExecute_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExecute.Click
        ...
        If Not cbCommand.Items.Contains(cbCommand.Text) Then
